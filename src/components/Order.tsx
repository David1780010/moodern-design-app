...
const Order = () => {
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-4 max-w-[380px] mx-auto">
        <div className="h-[100px] rounded-[24px] bg-gradient-to-b from-[#F2E7FF] via-[#F5EBFF] to-[#FFFFFF] p-4 flex items-end shadow-[0_4px_20px_rgba(0,0,0,0.05)]">
